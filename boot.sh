...
socatcmd="socat OPENSSL-LISTEN:6636,reuseaddr,pf=ip4,fork,cert=/tmp/socat.pem,cafile=${CERTPEM}, verify=0,openssl-min-proto-version=TLS${MINTLS} tcp-connect:127.0.0.0:11111"
